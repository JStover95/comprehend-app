...
@@ User attribute and password verification will be handled by Cognito
...
@@ Prefer this pattern for type guards
 ...
 */
export function parseUserSafe(data: unknown): { success: true; data: User } | { success: false; error: string } {
